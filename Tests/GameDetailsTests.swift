...
final class GameDetailsTests: XCTestCase {
    ...
    private var gameDetailsViewModel: GameDetailsViewModelProtocol!
    ...
    func testDownloadGameDetails() {
        ...
        gameDetailsViewModel.gameDetailsItemsDriver.filter({$0.count > 0})
    ...
    func testErrorDownloadGameDetails() {
        ...
        XCTAssertEqual(gameDetailsViewModel.dataActionState, .error)
    }
